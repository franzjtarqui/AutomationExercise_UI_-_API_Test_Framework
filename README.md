...
- **Practice site with third-party ads**: there may be residual flakiness under load/parallelism. Mitigated with robust waits, a `RetryAnalyzer` (retries any failing test once) and the nightly CI run.
